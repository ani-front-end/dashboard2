...
//                            },
                            data:[
                                {value:16, name:'A', itemStyle: {color : '#01deff',borderColor:'#01deff', opacity: 0.7}},
                                {value:4, name:'B', itemStyle: {color: '#b401ff',borderColor:'#b401ff', opacity: 0.7}},
                                {value:8, name:'C', itemStyle: {color: '#ff019c',borderColor:'#ff019c', opacity: 0.7}},
                                {value:7, name:'D', itemStyle: {color: '#ffba01',borderColor:'#ffba01', opacity: 0.7}},
                            ]
                        }
                    ]
                },
                ...
                tempData:[
                    {value:16, name:'A', desc:'人员管理',colorStyle:'#01deff', itemStyle: {borderColor:'#01deff', opacity: 0.7}},
                    {value:4, name:'B', desc:'枪弹管理',colorStyle:'#b401ff', itemStyle: {borderColor:'#b401ff', opacity: 0.7}},
                    {value:8, name:'C', desc:'车辆管理',colorStyle:'#ff019c', itemStyle: {borderColor:'#ff019c', opacity: 0.7}},
                    {value:7, name:'D', desc:'涉密载体管理',colorStyle:'#ffba01', itemStyle: {borderColor:'#ffba01', opacity: 0.7}},
                ],
                originData:{
                    '人员管理':135,
                    '枪弹管理':310,
...
//                              return true;
                              ...
                              let itemChart = {value:data[p], name:`${this.letterList[num]} ${this.toPercent(data[p]/data.allCount)}`, desc:p,colorStyle:this.colorList[num]};
                              let item = {value:data[p], name:this.letterList[num], desc:p,colorStyle:this.colorList[num]};

                              if(p != 'allCount' && data[p] != 0) {
                                  //图表显示
                                  this.orgOptions.series[1].data.push(itemChart)
