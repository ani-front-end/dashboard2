<template>
  <div class="content">
    ...
    <div class="content-top">
      <div class="top-main">
        <div class="main">
          <LegendNum :num=10 word="总数"></LegendNum>
        </div>
        <div class="main">
          <LegendNumNoBg :num=4 word="在外数"></LegendNumNoBg>
        </div>
        <div class="main">
          <LegendNumNoBg :num=6 word="在库数"></LegendNumNoBg>
        </div>
        <div class="main">
          ...
          <div class="bottom-right">
            ...
            <div class="right2">
              <div class="right2-top">
                <LittleLegendBlock word1="访客数" word2="亲属来队数"></LittleLegendBlock>
              </div>
        ...
        options:[
          {
            ...
            xAxis: {
              type: 'category',
              data: ['侦察营', '反坦克导弹营', '侦察营', '反坦克导弹营', '侦察营'],
              minInterval:1,
              axisLabel: {
                color: '#fff',
                fontSize: 10,
    ...
    methods: {
      ...
      onClick(event) {
        ...
        if(name){
          this.name = name;
          this.openDialog()
//                    this.http.get(`${this.ports.second.insertPersonSecond}/${name}`, (res) => {
//                        console.log('thirdBottomLeftLeft')
//                        console.log(res)
//                        if(res.success){
//                            let data = res.data;
          let data = {};
...
//                                if(p == 'countFact' || p == 'countShould' || p == 'division'){
//                                    return true;
//                                }
            this.dialogOptions[pageNum].xAxis[0].data.push(p)
            this.dialogOptions[pageNum].series[0].data.push(data[p].findPerson)
            this.dialogOptions[pageNum].series[1].data.push(data[p].insertPerson)
            num++;
