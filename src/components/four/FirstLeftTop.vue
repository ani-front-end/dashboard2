...
//                                return true;
                                ...
                                this.options[pageNum].series[0].data.push(data[p].心理疾病);
                                this.options[pageNum].series[1].data.push(data[p].思想波动);
                                this.options[pageNum].series[2].data.push(data[p].训练伤);
                                this.options[pageNum].series[3].data.push(data[p].身体疾病);
                                num++;
                                if (num > this.pageNums) {
                                    num = 0;
                                    this.options.push({
